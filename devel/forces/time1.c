...
* File time1.c
*
* Copyright (C) 2005, 2008-2013, 2016, 2021 Martin Luescher
*
...
int main(int argc,char *argv[])
{
   ...
   n=(int)(3.0e6/(double)(4*VOLUME_TRD));
   if (n<2)
      n=2;
   wdt=0.0;
   ...
   wdt=2.0e6*wdt/((double)(n)*(double)(4*VOLUME_TRD));

   if (my_rank==0)
   {
      printf("Time per link & thread:\n");
