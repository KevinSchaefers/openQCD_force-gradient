...
* File check2.c
*
* Copyright (C) 2005, 2008, 2012, 2013, 2016, 2021 Martin Luescher
*
...
int main(int argc,char *argv[])
{
   ...
   for (itm=0;itm<2;itm++)
   {
      ...
      set_s2zero(VOLUME_TRD,2,ps[0]);
      random_s(VOLUME_TRD,2,ps[1],1.0f);
      bnd_s2zero(ALL_PTS,ps[1]);
      normalize(VOLUME_TRD,3,ps[1]);
      assign_s2s(VOLUME_TRD,2,ps[1],ps[2]);
      ...
      for (n=0;n<8;n++)
      {
         ...
         res=norm_square(VOLUME_TRD,3,ps[1]);
         ...
         del[0]=norm_square(VOLUME_TRD,3,ps[3]);
         del[0]=(float)(sqrt((double)(del[0])));

         assign_s2s(VOLUME_TRD,2,ps[0],ps[3]);
         bnd_s2zero(ALL_PTS,ps[3]);
         mulr_spinor_add(VOLUME_TRD,2,ps[3],ps[0],-1.0f);
         del[1]=norm_square(VOLUME_TRD,3,ps[3]);
         del[1]=(float)(sqrt((double)(del[1])));

         assign_s2s(VOLUME_TRD,2,ps[1],ps[3]);
         bnd_s2zero(ALL_PTS,ps[3]);
         mulr_spinor_add(VOLUME_TRD,2,ps[3],ps[1],-1.0f);
         del[2]=norm_square(VOLUME_TRD,3,ps[3]);
