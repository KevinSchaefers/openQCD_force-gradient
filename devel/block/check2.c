...
* File check2.c
*
* Copyright (C) 2005, 2011, 2016, 2019, 2021 Martin Luescher
*
                     ...
                     int iu,int iud,int ns,int nsd,int shf)
{
   ...
   if (((ib<NTHREAD)&&((*b).shf!=(shf&0x1)))||
       ((ib>=NTHREAD)&&(((*b).shf!=shf))))
      return 1;

   if (shf&0x2)
   {
      if (((*bk).ipt!=(*b).ipt)||((*bk).iup!=(*b).iup)||
          ((*bk).idn!=(*b).idn))
         return 2;
   }
   ...
   if (iu==1)
   {
      if (((*b).u==NULL)||((shf&0x4)&&((*bk).u!=(*b).u)))
         return 3;
      if (check_u(4*vol,(*b).u))
         return 3;

      if (((*b).sw==NULL)||((shf&0x4)&&((*bk).sw!=(*b).sw)))
         return 3;
   ...
   if (iud==1)
   {
      if (((*b).ud==NULL)||((shf&0x8)&&((*bk).ud!=(*b).ud)))
         return 4;
      if (check_ud(4*vol,(*b).ud))
         return 4;

      if (((*b).swd==NULL)||((shf&0x8)&&((*bk).swd!=(*b).swd)))
         return 4;
   ...
   if (nsd>0)
   {
      if (((*b).sd==NULL)||((shf&0x20)&&((*bk).sd!=(*b).sd)))
         return 6;
                     ...
                     int iub,int iudb,int nw,int nwd,int shf)
{
   ...
   for (ifc=0;ifc<8;ifc++)
   {
      ...
      if (iub==1)
      {
         if (((*bb).u==NULL)||((shf&0x4)&&((*bbk).u!=(*bb).u)))
            return 7;
         if (check_u(vol,(*bb).u))
            return 7;
      }
      ...
      if (iudb==1)
      {
         if (((*bb).ud==NULL)||((shf&0x8)&&((*bbk).ud!=(*bb).ud)))
            return 8;
      ...
      if (nw>0)
      {
         if (((*bb).w==NULL)||((shf&0x40)&&((*bbk).w!=(*bb).w)))
            return 9;
      ...
      if (nwd>0)
      {
         if (((*bb).wd==NULL)||((shf&0x80)&&((*bbk).wd!=(*bb).wd)))
            return 10;
