...
* of the blocks) are copied.
*
* All these programs are thread-safe, but take it for granted that the block
* grid "grid" is allocated and that the other arguments are not out of range.
*
*******************************************************************************/
