...
* File cmatrix.c
*
* Copyright (C) 2007-2013, 2016, 2021  Martin Luescher, Isabel Campos
*
...
* unpredictable).
*
* If SSE or AVX instructions are used, and if n is even, it is taken for
* granted that the arrays are aligned to a 16 byte boundary.
*
...
static void cmat_transpose(int n,complex *a)
{
   int i,j;
   complex z;
