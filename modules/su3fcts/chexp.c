...
* File chexp.c
*
* Copyright (C) 2009-2013, 2016, 2022 Filippo Palombi, Martin Luescher
*
...
*     Allocates and initializes the static arrays used by the programs
*     in this module.
*
...
*
* The functions chexp_drv*() and expXsu3() assume that the program chexp_init()
* has previously been called by the master thread.
*
* The programs in this module do not perform any communications. Except
* for chexp_init(), which should only be called by the master thread, they
* are thread-safe.
*
* If SSE or AVX inline assembly is used, the arguments of type complex_dble,
* su3_alg_dble, su3_dble and ch_drv*_t must be aligned to a 16 byte boundary.
*
*******************************************************************************/
...
static void mapX2v(su3_alg_dble *X,su3_vector_dble *v)
{
...
void ch2mat(complex_dble *p,su3_alg_dble *X,su3_dble *u)
{
   ...
   (*u).c11.re=p[0].re-p[1].im*v[0].c1.im;
   (*u).c11.im=p[0].im+p[1].re*v[0].c1.im;
   (*u).c12.re=p[1].re*v[0].c2.re-p[1].im*v[0].c2.im;
   (*u).c12.im=p[1].re*v[0].c2.im+p[1].im*v[0].c2.re;
   (*u).c13.re=p[1].re*v[0].c3.re-p[1].im*v[0].c3.im;
   (*u).c13.im=p[1].re*v[0].c3.im+p[1].im*v[0].c3.re;

   (*u).c21.re=p[1].re*v[1].c1.re-p[1].im*v[1].c1.im;
   (*u).c21.im=p[1].re*v[1].c1.im+p[1].im*v[1].c1.re;
   (*u).c22.re=p[0].re-p[1].im*v[1].c2.im;
   (*u).c22.im=p[0].im+p[1].re*v[1].c2.im;
   (*u).c23.re=p[1].re*v[1].c3.re-p[1].im*v[1].c3.im;
   (*u).c23.im=p[1].re*v[1].c3.im+p[1].im*v[1].c3.re;

   (*u).c31.re=p[1].re*v[2].c1.re-p[1].im*v[2].c1.im;
   (*u).c31.im=p[1].re*v[2].c1.im+p[1].im*v[2].c1.re;
   (*u).c32.re=p[1].re*v[2].c2.re-p[1].im*v[2].c2.im;
   (*u).c32.im=p[1].re*v[2].c2.im+p[1].im*v[2].c2.re;
   (*u).c33.re=p[0].re-p[1].im*v[2].c3.im;
   (*u).c33.im=p[0].im+p[1].re*v[2].c3.im;

   z.re=_vector_prod_re(v[0],v[0]);
   (*u).c11.re-=p[2].re*z.re;
   (*u).c11.im-=p[2].im*z.re;

   z.re=_vector_prod_re(v[1],v[1]);
   (*u).c22.re-=p[2].re*z.re;
   (*u).c22.im-=p[2].im*z.re;

   z.re=_vector_prod_re(v[2],v[2]);
   (*u).c33.re-=p[2].re*z.re;
   (*u).c33.im-=p[2].im*z.re;

   z.re=_vector_prod_re(v[0],v[1]);
   z.im=_vector_prod_im(v[0],v[1]);
   ...
   z.re=_vector_prod_re(v[0],v[2]);
   z.im=_vector_prod_im(v[0],v[2]);
   ...
   z.re=_vector_prod_re(v[1],v[2]);
   z.im=_vector_prod_im(v[1],v[2]);
...
static void eval_td(su3_alg_dble *X,double *t,double *d)
{
   su3_vector_dble v[4] ALIGNED16;
   ...
   mapX2v(X,v);
   _vector_cross_prod(v[3],v[1],v[2]);
   (*d)=_vector_prod_im(v[0],v[3]);
}
...
void expXsu3(double eps,su3_alg_dble *X,su3_dble *u)
{
   ...
   double nfrb;
   su3_dble *u1,*u2,*u3;
   su3_alg_dble Ys ALIGNED16;
   su3_dble ws[2] ALIGNED16;
   ch_drv0_t sw ALIGNED16;
