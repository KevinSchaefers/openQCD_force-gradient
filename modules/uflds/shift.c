...
* File shift.c
*
* Copyright (C) 2006, 2009, 2011-2013, 2016, 2021 Martin Luescher
*
...
* automatically.
*
* The program shift_ud() is assumed to be called by the OpenMP master thread
* on all MPI processes simultaneously. No use of OpenMP parallel processing
* is made. The program therefore tends to be slow and should not be used in
* programs where the performance matters.
*
*******************************************************************************/
...
static int bs[4],np[4],nlk[4],npt[4],ofs[4];
...
static void alloc_udbufs(void)
{
   ...
   error(ipt==NULL,1,"alloc_udbufs [shift.c]",
