...
* File vflds.c
*
* Copyright (C) 2011, 2013, 2022 Martin Luescher
*
...
* must therefore be called simultaneously by the openMP master thread on
* all MPI processes.
*
*******************************************************************************/
...
static void vfld_size(void)
{
   ...
   error(Ns==0,1,"vfld_size [vflds.c]",
