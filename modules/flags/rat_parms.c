...
* File rat_parms.c
*
* Copyright (C) 2012, 2013, 2021 Martin Luescher
*
...
*     Reads rational-function parameters on MPI process 0 from the parameter
*     section [Rational <int>] on stdin, <int> being the number irp of the
*     rational function to be entered to the parameter data base. The tags
*
*       degree  <int>
*       range   <double> <double>
*
