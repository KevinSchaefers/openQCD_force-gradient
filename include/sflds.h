...
/* SFLDS_C */
extern void set_s2zero(int vol,int icom,spinor *s);
extern void set_sd2zero(int vol,int icom,spinor_dble *sd);
extern void random_s(int vol,int icom,spinor *s,float sigma);
extern void random_sd(int vol,int icom,spinor_dble *sd,double sigma);
extern void assign_s2s(int vol,int icom,spinor *s,spinor *r);
extern void assign_s2sd(int vol,int icom,spinor *s,spinor_dble *rd);
extern void assign_sd2s(int vol,int icom,spinor_dble *sd,spinor *r);
extern void assign_sd2sd(int vol,int icom,spinor_dble *sd,spinor_dble *rd);
extern void add_s2s(int vol,int icom,spinor *s,spinor *r);
extern void add_s2sd(int vol,int icom,spinor *s,spinor_dble *rd);
extern void diff_s2s(int vol,int icom,spinor *s,spinor *r);
extern void diff_sd2s(int vol,int icom,spinor_dble *sd,spinor_dble *rd,
                      spinor *r);
