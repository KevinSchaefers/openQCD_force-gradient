...
/* BLOCK_C */
extern int alloc_blk(block_t *b,int *bo,int *bs,
                     int iu,int iud,int ns,int nsd);
extern int alloc_bnd(block_t *b,int iu,int iud,int nw,int nwd);
extern int clone_blk(block_t *b,int shf,int *bo,block_t *c);
extern int free_blk(block_t *b);
...
extern void assign_swd2swdblk(blk_grid_t grid,int n);
